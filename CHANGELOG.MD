...
- Added Auto Use (#73): can be used as an auto pot, auto rod, auto soup for example
...
- Added Speed Bridging (#72): people usually call this scaffolding

**Misc:**
- Should be compatible with MC 1.16.1 and MC 1.16.2
