...
*Everything has been recoded from zero. Now adding new modules is extremely easy and everything is optimized.*
- Interface :
    - A new external interface made to contain a lot of modules,
- Modules :
    - Aim assistance :
        - ...
    - Click Assistance :
