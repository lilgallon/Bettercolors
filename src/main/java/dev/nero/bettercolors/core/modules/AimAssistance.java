...
public class AimAssistance extends BetterModule {
    ...
    private void analyseEnvironment() {
        ...
        final Class<? extends Entity> ENTITY_TYPE = (this.getOptionB(I_USE_ON_MOBS) ? EntityLivingBase.class : EntityPlayer.class);
    ...
    private void assistIfPossible() {
        ...
        if (this.target != null && this.assist) {
            ...
            if(Wrapper.MC.objectMouseOver != null) {
                isAimingEntity = Wrapper.MC.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY;
            }
