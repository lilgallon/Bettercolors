...
public class Antibot extends Module {
    ...
    protected void onEvent(int code, Object details) {
        ...
        switch (code) {
            ...
            case EventType.ENTITY_JOIN:
                ...
                if (joinWorldEvent.entity instanceof EntityPlayer) {
                    this.entities.put(
                            joinWorldEvent.entity.getEntityId(),
                            new Data()
                    );
                }
            ...
            /* no leave event for forge 1.8.9
            ...
            */
            ...
            case EventType.CLIENT_TICK:
                if (!this.entitiesLoaded && Wrapper.MC.theWorld != null) {
                    Wrapper.MC.theWorld.playerEntities.forEach((entity -> this.entities.put(
                            entity.getEntityId(),
                            new Data()
                    )));
            ...
            case EventType.ENTITY_ATTACK:
                ...
                Entity source = livingHurtEvent.source.getSourceOfDamage();
                Entity target = livingHurtEvent.entity;
                ...
                if (source instanceof EntityPlayer) {
                    ...
                    // TODO: test
                    System.out.println(source.getName() + "attacked someone");
    ...
    public boolean isBot(EntityLivingBase entity) {
        ...
        if (Wrapper.MC.getNetHandler().getPlayerInfo(player.getUniqueID()).getResponseTime() == 0 && PING_CHECK) return true;
     ...
     */
    public boolean isInTab(EntityPlayer entity) {
        for(NetworkPlayerInfo info : Wrapper.MC.getNetHandler().getPlayerInfoMap()) {
            if (info.getGameProfile().getName().equals(entity.getName())) return true;
        }
