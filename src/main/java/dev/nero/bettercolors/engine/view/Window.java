    ...
    public Window(String title, ArrayList<Module> modules, Version version) {
        ...
        try {
            ...
            setIconImage(new ImageIcon(Objects.requireNonNull(
                    Thread.currentThread()
                            ...
                            .getResource("assets/mcp/bettercolors_symbol.png")))
                    .getImage()
            );
        } catch (Exception e) {
            e.printStackTrace();
            WARN("Failed to load assets/mcp/bettercolors_symbol.png");
        }
        ...
        try {
            consoleFont = Font.createFont(
                    Font.TRUETYPE_FONT,
                    getClass().getResource("/assets/mcp/CascadiaCode.ttf").openStream()
            );
            ...
            try {
                ImageIcon icon = new ImageIcon(
                        Objects.requireNonNull(
                                Thread.currentThread().
                                        getContextClassLoader().
                                        getResource("assets/mcp/" + module.getSymbol())
                        )
                );
                tabbedPane.addTab(module.getName(), icon, content);
            } catch (Exception e) {
                e.printStackTrace();
                WARN("Failed to load assets/mcp/" + module.getSymbol());
        ...
        try {
            ImageIcon icon = new ImageIcon(
                    Objects.requireNonNull(
                            Thread.currentThread()
                                    .getContextClassLoader()
                                    .getResource("assets/mcp/settings_symbol.png")
                    )
            );
            tabbedPane.addTab("Settings", icon, settingsPanel);
        } catch (Exception e) {
            e.printStackTrace();
            WARN("Failed to load assets/mcp/settings_symbol.png");
        ...
        try {
            ImageIcon icon = new ImageIcon(
                    Objects.requireNonNull(
                            Thread.currentThread()
                                    .getContextClassLoader()
                                    .getResource("assets/mcp/sprint_symbol.png")
                    )
            );
            tabbedPane.addTab("Friends", icon, friendListPanel);
        } catch (Exception e) {
            e.printStackTrace();
            WARN("Failed to load assets/mcp/sprint_symbol.png");
